...
int main() {
	...
	complicated.someMap[Color::Red] = std::make_shared<std::array<uint16_t, 5>>(std::array<uint16_t, 5> {{1, 2, 3, 4, 5}});
	complicated.someMap[Color::Orange] = std::make_shared<std::array<uint16_t, 5>>(std::array<uint16_t, 5> {{10, 9, 8, 7, 6}});
	complicated.someMap[Color::Green] = std::make_shared<std::array<uint16_t, 5>>(std::array<uint16_t, 5> {{31, 41, 59, 26, 53}});
	complicated.someMap[Color::Black] = std::make_shared<std::array<uint16_t, 5>>(std::array<uint16_t, 5> {{1, 7, 7, 6, 0}});
	...
	complicated.wackyStack.push(7);
	complicated.wackyStack.push(3);
	complicated.wackyStack.push(84);
	complicated.wackyStack.push(20961);
